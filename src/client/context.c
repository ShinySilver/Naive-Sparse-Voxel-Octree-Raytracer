...
static int win_width, win_height, win_x, win_y;
    ...
    if (action == GLFW_PRESS) {
        switch (key) {
            ...
            case GLFW_KEY_F2:
                ...
                INFO(context_heat_map_mode ? "Enabling computation time heat map" : "Disabling computation time heat map");
                break;
            case GLFW_KEY_F3:
            ...
            case GLFW_KEY_ESCAPE:
                INFO("User pressed Escape. Client will now exit");
